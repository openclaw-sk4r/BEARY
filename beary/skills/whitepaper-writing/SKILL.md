...
If `.agent/skills/beary/USER.md` exists, read it to understand the user's specific needs, audience, and priorities before writing the whitepaper.
...
## 1. Read User Context
If `.agent/skills/beary/USER.md` exists, read it first to understand the user's audience and research priorities. This will inform how you frame questions and what sources to prioritize.
